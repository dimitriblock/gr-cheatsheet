...
\usepackage[a0paper, margin=1cm]{geometry}
\usepackage{graphicx}
\usepackage{listings}
\usepackage{color}
...
\lstset{ %
  ...
  basicstyle=\Huge,        % the size of the fonts that are used for the code
  ...
  title=\Huge\lstname                   % show the filename of files included with \lstinputlisting; also try caption instead of title
}
